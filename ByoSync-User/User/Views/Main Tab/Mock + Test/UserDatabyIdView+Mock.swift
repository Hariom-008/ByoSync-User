...
extension UserById{
    static var mock: UserById{
        ...
        """
        return MockDecode.decode(UserById.self, json: json)
    }
}

extension DeviceById{
    static var mockPrimary: DeviceById{
        let json = """
        {
          "_id": "dev_abc123",
        ...
        """
        return MockDecode.decode(DeviceById.self, json: json)
    }
}
#endif
